...
void endGame();
void resetGameState();
void startNewGame(); // Nouvelle fonction pour déclencher une nouvelle partie
...
// Rétablissement de l'état initial pour une nouvelle partie
void resetGameState() {
  gameEnded = false;
...
void startNewGame() {
  Serial1.println("RESET GAME"); // Commande pour ScoreSender
  Serial.println("🚀 Nouvelle partie demandée à ScoreSender.");
}
